...
describe('i18n', () => {
  ...
  it('the footer description elements do not render their i18n keys', () => {
    cy.get(selectors.footer.taxExemptStatus).should('not.equal', 'footer.tax-exempt-status');
    cy.get(selectors.footer.missionStatement).should('not.equal', 'footer.our-nonprofit');
    cy.get(selectors.footer.donationInitiatives).should('not.equal', 'footer.donation-initiatives');
  ...
  it('the bottom footer links do not render their i18n keys', () => {
    ...
    cy.get(selectors.footer.ourNonprofit).should('not.equal', 'footer.our-nonprofit');
    ...
    cy.get(selectors.footer.links.alumni)
      ...
      .should('have.attr', 'href')
      .should('equal', 'https://www.linkedin.com/school/free-code-camp/people/');
